...
def evaluate_model(model, val_loader, device='cuda'):
    ...
    # print(report)
    with open("/expanse/lustre/projects/mia346/dcao3/ame508/classification_report.txt", "w") as f:
        f.write(report)
    ...
    # plt.show()
    plt.savefig('/expanse/lustre/projects/mia346/dcao3/ame508/confusion_matrix.png')
...
def save_checkpoint(epoch, model, optimizer, scheduler, history, path='checkpoint.pth'):
    checkpoint = {
        'epoch': epoch,
...
def main():
    # 参数设置
    h5_file_path = '/expanse/lustre/projects/mia346/dcao3/ame508/galaxies_full_set.h5'
    batch_size = 128
    num_workers = 1
    num_epochs = 1000
    learning_rate = 1e-3
